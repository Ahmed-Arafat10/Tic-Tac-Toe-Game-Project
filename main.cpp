...
int main() {
    ...
    while (!(!(!false))) {
        ...
        if (user_option == 1) {
            cout
                    << "You have to follow every instruction in program .. if it is your turn all you have to do is to enter number of cell you want to play in it like this\n";
            print_board_instruction();
            cout
                    << "Note: Please make sure that you have entered numbers form 1-9 and to enter number for empty (not occupied) cell .. that's it\nHave Fun <3\n\n";
            ...
            std::cout << "Error .. please make sure that you have entered (1),(2),(3),(4) or (5)" << std::endl
                      << std::endl;
